...
function normalizeUrlForComparison(url, logger, correlationId) {
  ...
  try {
    ...
    logger == null ? void 0 : logger.error(`15apdm ${e}`, correlationId || "");
    throw createClientConfigurationError(urlParseError);
  }
}
function validateUrl(url, logger, correlationId) {
  try {
    ...
    logger == null ? void 0 : logger.error(`1lrjz7 ${e}`, correlationId || "");
    throw createClientConfigurationError(urlParseError);
  }
}
...
function clearAuthResponseFromUrl(contentWindow) {
  var _a;
  if (typeof ((_a = contentWindow.history) == null ? void 0 : _a.replaceState) === "function") {
...
async function waitForBridgeResponse(timeoutMs, logger, request, performanceClient, experimentalConfig) {
  return new Promise((resolve, reject) => {
    ...
    const { libraryState } = ProtocolUtils_exports.parseRequestState(base64Decode, request.state || "");
...
function createNativeAuthError(code, description, ext) {
  if (ext && ext.status) {
    switch (ext.status) {
      ...
      case UI_NOT_ALLOWED:
        return createInteractionRequiredAuthError(InteractionRequiredAuthErrorCodes_exports.uiNotAllowed);
    }
  }
...
var PlatformAuthInteractionClient = class extends BaseInteractionClient {
  ...
  async acquireTokenRedirect(request, rootMeasurement, options) {
    ...
    const redirectUri = navigateToLoginRequestUrl ? UrlString.getAbsoluteUrl(request.redirectStartPage || window.location.href, getCurrentUri()) : getRedirectUri(request.redirectUri, this.config.auth.redirectUri, this.logger, this.correlationId);
...
var StandardController = class _StandardController {
  ...
  createPopupClient(correlationId) {
    var _a;
    return new PopupClient(this.config, this.browserStorage, this.browserCrypto, this.logger, this.eventHandler, this.navigationClient, this.performanceClient, this.nativeInternalStorage, correlationId, this.platformAuthProvider, (_a = this.operatingContext.getResponseHandlers()) == null ? void 0 : _a.waitForPopupResponse);
  }
  /**
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-DJC6ZZB4.js");
    }
  } catch (e) {
  }
  return void 0;
...
@azure/msal-browser/dist/telemetry/BrowserPerformanceEvents.mjs:
  (*! @azure/msal-browser v5.14.0 2026-06-16 *)
